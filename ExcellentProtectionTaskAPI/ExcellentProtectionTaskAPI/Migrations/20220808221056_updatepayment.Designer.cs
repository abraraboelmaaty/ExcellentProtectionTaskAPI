...
namespace ExcellentProtectionTaskAPI.Migrations
{
    ...
    [Migration("20220808221056_updatepayment")]
            ...
            modelBuilder.Entity("ExcellentProtectionTaskAPI.Models.OrderPayment", b =>
                {
                    ...
                    b.Property<DateTime?>("Date")
                        ...
                        .HasDefaultValue(new DateTime(2022, 8, 9, 0, 10, 56, 312, DateTimeKind.Local).AddTicks(9985));
            ...
            modelBuilder.Entity("ExcellentProtectionTaskAPI.Models.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 9, 0, 10, 56, 312, DateTimeKind.Local).AddTicks(9508));
