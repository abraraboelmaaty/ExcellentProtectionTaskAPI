...
namespace ExcellentProtectionTaskAPI.Migrations
{
    ...
    [Migration("20220808215720_updatecontextandpayment1")]
    partial class updatecontextandpayment1
    {
            ...
            modelBuilder.Entity("ExcellentProtectionTaskAPI.Models.OrderPayment", b =>
                {
                    ...
                    b.Property<DateTime?>("Date")
                        ...
                        .HasDefaultValue(new DateTime(2022, 8, 8, 23, 57, 20, 308, DateTimeKind.Local).AddTicks(9461));
            ...
            modelBuilder.Entity("ExcellentProtectionTaskAPI.Models.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 8, 23, 57, 20, 308, DateTimeKind.Local).AddTicks(8922));
