...
namespace ExcellentProtectionTaskAPI.Migrations
{
    ...
    [Migration("20220807234448_updateorderandcontext")]
    partial class updateorderandcontext
    {
            ...
            modelBuilder.Entity("ExcellentProtectionTaskAPI.Models.OrderPayment", b =>
                {
                    ...
                    b.Property<DateTime?>("Date")
                        ...
                        .HasDefaultValue(new DateTime(2022, 8, 8, 1, 44, 48, 616, DateTimeKind.Local).AddTicks(1181));
            ...
            modelBuilder.Entity("ExcellentProtectionTaskAPI.Models.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 8, 8, 1, 44, 48, 616, DateTimeKind.Local).AddTicks(750));
